...
-- удалить указанную таблицу если она уже существует
...
VALUES ('Jon', 'Snow', 17, 'Winterfell');

/* Изменить значение поля */
UPDATE persons
SET second_name = 'Targaryen',
    age         = 23,
    address= 'the Wall';
...
SELECT *
FROM persons; -- Показать выборку всех значений таблицы
